...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--procs', type=int, default = 1, help='number of processes to use. [1]')
    parser.add_argument('--sub', type=float, default=0.03, help='substitution rate. [0.03]')
    parser.add_argument('--ins', type=float, default=0.03, help='insertion rate. [0.03]')
    parser.add_argument('--dele', type=float, default=0.03, help='deletion rate. [0.03]')
