...
* for all operations that operate on one sequence at a time should try to use a generator or sth, so 
no need to have everything in memory then give to SeqIO.write
'''
